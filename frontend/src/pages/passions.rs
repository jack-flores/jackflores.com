        ...
        <div class="flex flex-col min-h-screen">
            ...
            <SectionsWrapper header="Passions">
                <Section title="Music -- Recording, Production, Songwriting, and Performing" subtitle="2018 - present">
                    {"I am a self-taught musician, having mastered several instruments, recording and production techniques, and songwriting. While I am not considering a career in music, I am always developing new songs and exploring new techniques. I plan on publishing some of my work to Spotify and other platforms in 2026. "}
                    ...
                    {"In addition to my solo work, I also sing and play bass in  my band, "} <PageBodyLink href="https://www.instagram.com/jackscatband">{"Jack's Cat!"}</PageBodyLink>{" I've also played with other bands and artists, including "} <PageBodyLink href="https://www.instagram.com/badneighboursma">{"Bad Neighbours"}</PageBodyLink>{", "}  <PageBodyLink href="https://open.spotify.com/artist/68mLDLEEAbm6qSRMGd7lCu">{"Aaron Acapella"}</PageBodyLink>{", "}<PageBodyLink href="https://open.spotify.com/artist/7zVqDOl6N7PAmPFSvzw52M">{"Cole Rowland"}</PageBodyLink>{", and the worship band at "}<PageBodyLink href="https://www.pacificpointchurch.com/">{"Pacific Point Church."}</PageBodyLink><br/><br/>
                ...
                <Section title="Sailing" subtitle="2010 - present">
                    {"I have dedicated a significant amount of my life to competitive sailing, having competed in national and world championships as both a skipper and a crew. During my time at Tufts, I was a dedicated member of the Tufts Varsity Sailing Team. For my senior year, I was elected as one of three Co-Captains of the Tufts team, a role that I cherished and was honored to serve."}<br/><br/>
