        ...
        <div class="flex flex-col min-h-screen">
            ...
            <SectionsWrapper header="Projects">
                <Section title="Portfolio Website -- Where you are now!" subtitle="April 2025 - Present">
                    {"I used this project as an opportunity to show off my full-stack development skills while delivering an easily-navigable portfolio. Visit the "}<PageBodyLink href="https://github.com/jack-flores/portfolio">{"GitHub repository linked here!"}</PageBodyLink><br/><br/>
                    <b>{"Highlights:"}</b><br/>
                    ...
                    <b>{"Tools Used: "}</b> {"Rust, Yew Framework (frontend), Tailwind CSS, Actix Web Framework (backend), GitHub, HTML, Docker, Fly.io, Project Design, Project Management"}
                </Section>
